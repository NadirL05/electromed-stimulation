  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <button className="hidden rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold text-zinc-900 shadow-lg shadow-orange-500/30 transition hover:bg-orange-400 md:inline-block">
          Connexion
        </button>

        {/* Bouton mobile */}
        <button
          className="inline-flex items-center justify-center rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold text-zinc-900 shadow-lg shadow-orange-500/30 transition hover:bg-orange-400 md:hidden"
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-16 pt-4 md:flex-row md:items-center md:gap-16">
        <div className="flex-1 space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            <a
              href="#"
              className="inline-flex items-center justify-center rounded-full bg-orange-500 px-6 py-3 text-sm font-semibold text-zinc-900 shadow-lg shadow-orange-500/30 transition hover:bg-orange-400"
            >
              Essayer gratuitement
            </a>
            <a
              href="#"
              className="inline-flex items-center justify-center rounded-full border border-white/10 px-6 py-3 text-sm font-semibold text-white transition hover:border-white/30 hover:bg-white/5"
            >
              En savoir plus
            </a>
          </div>
